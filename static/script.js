...
// Complex Crap For Paralax Hover Effect
(() => {
  "use strict";
  !(function () {
    function e(e) {
    ...
    function s(e) {
      ...
      if (
        t.classList.contains("with-shadow") &&
        !t.querySelector(".shadow") &&
        n &&
        !n.matches
      ) {
      ...
      h && (h.style.perspective = 2.5 * u + "px"),
        ...
        t.querySelectorAll(".parallax-content").forEach((e, t) => {
          if (n && !n.matches) {
            t++;
            const n = e.classList.contains("reverse") ? 0.2 : -0.65;
            e.style.transform =
      ...
      f &&
        n &&
        !n.matches &&
        ((f.style.width = 1.5 * u + "px"),
        (f.style.height = 1.5 * u + "px"),
        (f.style.margin = -0.75 * u + "px 0 0 " + -0.75 * u + "px"),
        (f.style.transform =
          "translateY(" +
          (c - l / 2) +
          "px) translateX(" +
      ...
      if (m)
        if (n && !n.matches && c < l / 3) {
          const e = (1 / (l / 3)) * (l / 3 - c);
          (m.style.opacity = e.toString()),
            (m.style.boxShadow =
              "inset 0 " +
              -1 * e +
              "em .4em -.5em rgba(0,0,0," +
              Math.min(e, 0.35) +
              ")");
